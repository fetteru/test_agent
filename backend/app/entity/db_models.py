...
class TrainingTask(Base):
    ...
    task_uuid = Column(String(100), unique=True, nullable=False, index=True, comment="任务唯⼀标识")
...
class OperationLog(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    user_id = Column(Integer, ForeignKey("users.id"), nullable=True, index=True, comment="操作⽤户（可为空表示系统操作）")
